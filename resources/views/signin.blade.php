        ...
        <form class="mt-8 space-y-6" action="{{ route('signin') }}" method="POST">
            ...
            <div>
                ...
                <a href="{{ route('auth.google') }}"
                    class="mt-3 w-full inline-flex items-center justify-center gap-2 py-3.5 px-4 border border-gray-300 rounded-[20px] text-sm font-semibold text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-200 transition-all duration-300">
