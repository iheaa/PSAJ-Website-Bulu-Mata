    ...
    <script>
        wind.config = {
            ...
            5DC',
                                            E7CE',
                                                                      'nar                                          'narita-                                  },
        ['Playfair Di                                      sans: ['Inter', 'sans - se                        
                }
            }
        }
    </script>
...
<body class="font-sans antialiased text-gray-600 bg-white">
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
        <div
            ...
            <!-- Left Content -->
            <div class="w-full lg:w-1/2 space-y-8 relative z-10 text-center lg:text-left">
                <!-- Logo Mark (Optional smaller logo or badge) -->
                <div class="flex justify-center lg:justify-start">
                    <img src="{{ asset('img/logo.png') }}" alt="" class="h-24 opacity-80">
                </div>
    ...
    <section class="max-w-7xl mx-auto px-6 py-20 lg:py-32">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-center">
            ...
            <div class="lg:col-span-5 text-center lg:text-right space-y-6">
