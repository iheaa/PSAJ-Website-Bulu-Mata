            ...
            <form action="{{ route('admin.catalogs.update', $catalog->id) }}" method="POST"
                ...
                <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <div class="mt-1">
                            <input type="text" name="name" id="name" value="{{ $catalog->name }}"
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <div class="mt-1">
                            <textarea id="description" name="description" rows="3"
                                ...
                                required>{{ $catalog->description }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-1">
                            <input type="text" name="price" id="price"
                                value="{{ number_format($catalog->price, 0, ',', '.') }}"
                                class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md p-2 border"
                                required>
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-1">
                            <input type="number" step="1" name="stock" id="stock" value="{{ $catalog->stock }}"
                                class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md p-2 border"
                                required>
                        </div>
                    </div>
                    ...
                    <!-- New Image -->
                    <div class="sm:col-span-6">
                        <label for="image" class="block text-sm font-medium text-gray-700">Change Image
                            (Optional)</label>
                        <div
