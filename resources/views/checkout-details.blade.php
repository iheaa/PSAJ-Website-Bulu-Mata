                ...
                <div class="bg-white p-6 md:p-8 rounded-2xl shadow-sm border border-gray-100">
                    <div class="flex items-start justify-between gap-4 mb-6">
                        <h2 class="text-lg md:text-xl font-bold text-gray-900 flex items-center gap-2">
                            <span class="bg-orange-100 text-orange-600 w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold">1</span>
                            Informasi Pengiriman
                        </h2>
                        <div class="text-xs text-gray-400 mt-1">Wajib diisi (<span class="text-red-500">*</span>)</div>
                    </div>
                ...
                <div class="bg-white p-6 md:p-7 rounded-2xl shadow-sm border border-gray-100 sticky top-24">
                    ...
                    <div class="border-t border-gray-100 pt-4 space-y-2 text-sm mb-6">
                        ...
                        <div class="flex justify-between items-center pt-3 mt-3 border-t border-dashed border-gray-200">
                            ...
                            <span class="text-xl md:text-2xl font-extrabold text-orange-600">Rp {{ number_format($grandTotal, 0, ',', '.') }}</span>
                        </div>
                    </div>
